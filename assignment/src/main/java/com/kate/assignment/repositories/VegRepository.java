...
public interface VegRepository extends JpaRepository<Vegetables, Integer> {
    ...
    String selectAllFields = "vegetables.vegetable_id, vegetables.price, " +
            "vegetable_discounts.vegetable_discount_id, vegetable_discounts.minimum_weight, vegetable_discounts.maximum_weight, vegetable_discounts.discount_percentage ";
    ...
    @Query(nativeQuery = true, value = "SELECT " +
            ...
            "AND ?2 BETWEEN  vegetable_discounts.minimum_weight AND vegetable_discounts.maximum_weight ")
    public VegWithDiscountInterface getDiscountDetails(Integer vegetableId, Integer vegetableQuantity);
